...
//        }
//    }else{
    [manager GET:pathUrl parameters:parameters headers:nil progress:nil success:^(NSURLSessionDataTask * _Nonnull task, id  _Nullable responseObject) {
        NSDictionary* json;
...
//        [LCPNetWorkManager getWithPathUrl:LCP_UPLOADFILE parameters:nil queryParams:nil Header:nil success:^(BOOL success, id JSON) {

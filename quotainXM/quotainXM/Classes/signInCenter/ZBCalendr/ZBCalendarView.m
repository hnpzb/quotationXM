...
- (void)settingHeadLabel_two {
    /*
     ...
     label.frame = CGRectMake(18,86.5,29,11);
     label.numberOfLines = 0;
     [self.view addSubview:label];

     NSMutableAttributedString *string = [[NSMutableAttributedString alloc] initWithString:@"Web" attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 14],NSForegroundColorAttributeName: [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0]}];

     label.attributedText = string;
     label.alpha = 0.5;
     */
    
    NSArray *weekdays = @[@"Web",@"Thu",@"Fri",@"Sat",@"Sun",@"Mon",@"Tub"];
    CGFloat weekdayW = ViewW/7;
    for (int i = 0; i < 7; i++) {
        UILabel *weekL = [[UILabel alloc] initWithFrame:CGRectMake(i*weekdayW, 0, weekdayW, weeksH)];
        weekL.font = [UIFont fontWithName:@"PingFang SC" size: 14];
        weekL.textColor = [UIColor colorWithRed:255/255.0 green:255/255.0 blue:255/255.0 alpha:1.0];
        
        weekL.backgroundColor = [UIColor redColor];
